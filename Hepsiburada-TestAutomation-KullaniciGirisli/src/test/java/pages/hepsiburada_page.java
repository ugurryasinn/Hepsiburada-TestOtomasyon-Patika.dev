...
public class hepsiburada_page {
    ...
    @FindBy(xpath = "/html/body/div[1]/div/div/div[3]/div[5]/div/div/div/div/div[2]/div[3]/div[2]")
    public WebElement girisyapmenu;

    @FindBy(linkText = "Giriş Yap")
    public WebElement girisyapbutton;

    @FindBy(xpath = "/html/body/div[1]/div/div/div[1]/div[2]/div/div/div[2]/div[2]/div/div/form/div/div[1]/input")
    public WebElement emailbox;

    @FindBy(name = "btnLogin")
    public WebElement emailgiris;

    @FindBy(xpath = "/html/body/div[2]/div[2]/div/div[1]/div/div[2]/div/button[2]")
    public WebElement cookies;

    @FindBy(xpath = "/html/body/div[1]/div/div/div[1]/div[2]/div/div/form/div/div/input")
    public WebElement passwordbox;

    @FindBy(xpath = "/html/body/div[1]/div/div/div[1]/div[2]/div/div/form/button")
    ...
    @FindBy(xpath = "/html/body/div[1]/div/div/div[3]/div[5]/div/div/div/div/div[2]/div[3]/div[2]/span/a/span[2]")
    ...
    @FindBy(xpath = "/html/body/div[2]/main/div[3]/section[1]/div[1]/div/header/span")
    public WebElement click_of_product_text;

    @FindBy(xpath = "/html/body/div[7]/div/div/div/div/div/div/div[1]/div/div[1]/div/div[1]/div/h6")
    public WebElement other_product_information;

    @FindBy (xpath = "/html/body/div[2]/main/div[3]/section[1]/div[1]/div/header/span")
    public WebElement click_of_other_product_text;
